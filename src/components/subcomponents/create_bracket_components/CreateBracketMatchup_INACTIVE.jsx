...
const CreateBracketMatchup_INACTIVE = ({ seedingEnabled, seed1, seed2, oneTeam, returnTeams }) => {
    return (
...
CreateBracketMatchup_INACTIVE.propTypes = {
...
export default CreateBracketMatchup_INACTIVE
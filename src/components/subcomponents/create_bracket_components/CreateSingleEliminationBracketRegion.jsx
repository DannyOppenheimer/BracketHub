...
import styles from './CreateSingleEliminationBracketRegion.module.css';
import CreateBracketMatchup_BLANK from './CreateBracketMatchup_BLANK';
import CreateBracketMatchup_INACTIVE from './CreateBracketMatchup_INACTIVE';
...
const CreateSingleEliminationBracketRegion = ({ data, regionNum, sendBracketUp, currentBracketBuild }) => {
                                            ...
                                            <div key={`cell_${j}`} className={styles.cell}>
                                                {
                                                    bracket[round][matchup].team1 === null && bracket[round][matchup].team2 === null
                                                        ?
                                                        <CreateBracketMatchup_INACTIVE key={`inactive_cell_${j}`} oneTeam={false} />
                                                        :
                                                        <CreateBracketMatchup_BLANK key={`cell_${bracket[round][matchup].team1}_${bracket[round][matchup].team2}`} region={regionNum} seedingEnabled={seedingOn} seed1={bracket[round][matchup].team1} seed2={bracket[round][matchup].team2} sendBracketUp={sendBracketUp} currentBracketBuild={currentBracketBuild} />
...
export default CreateSingleEliminationBracketRegion
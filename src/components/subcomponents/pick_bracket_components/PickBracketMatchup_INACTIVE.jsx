...
const PickBracketMatchup_INACTIVE = ({ seedingEnabled, seed1, seed2, oneTeam, returnTeams }) => {
    return (
...
PickBracketMatchup_INACTIVE.propTypes = {
...
export default PickBracketMatchup_INACTIVE